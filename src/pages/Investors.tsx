...
const Investors = () => {
  ...
  const slides = [
    {
      ...
      content: (
        <div className="flex flex-col items-center justify-center h-full bg-white">
          ...
          <h2 className="skribh-title mb-8 text-skribh-navy">Skribh</h2>
          <p className="text-2xl text-center mb-8 max-w-3xl text-skribh-navy">
            Automated, HIPAA-compliant medical documentation via ambient AI
            transcription
          </p>
          <div className="bg-white border-l-4 border-skribh-navy p-8 w-full max-w-3xl shadow-md">
            <ul className="space-y-4 text-xl text-skribh-navy">
              <li className="flex items-center">
                <span className="inline-block w-3 h-3 bg-skribh-navy rounded-none mr-3"></span>
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col h-full">
          <h2 className="text-4xl font-bold mb-8 text-skribh-navy">
            Documentation Burden Crippling EMS Efficiency
          </h2>
          <div className="space-y-6">
            <div className="bg-skribh-deepnavy/80 border-l-4 border-skribh-navy p-6">
            ...
            <div className="bg-skribh-deepnavy/80 border-l-4 border-skribh-navy p-6">
              ...
              <ul className="space-y-4 text-lg">
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 bg-skribh-navy rounded-none mr-3 mt-2"></span>
                ...
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 bg-skribh-navy rounded-none mr-3 mt-2"></span>
                  Providers distracted by documentation instead of focusing on
                  patient care
                </li>
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 bg-skribh-navy rounded-none mr-3 mt-2"></span>
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col h-full">
          ...
          <div className="overflow-hidden bg-skribh-deepnavy/80 border-l-4 border-skribh-navy">
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-skribh-navy/20">
                  <th className="p-4 text-left text-xl border-b border-white/10">
                    Solution
                  </th>
                  <th className="p-4 text-left text-xl border-b border-white/10">
                    Limitations
              ...
              <tbody>
                <tr className="border-b border-white/10">
                  ...
                  <td className="p-4 text-lg">
                    Non-HIPAA, workflow-disconnected
                  </td>
                </tr>
                <tr className="border-b border-white/10">
                  ...
                  <td className="p-4 text-lg">
                    No time savings (45-60 mins/report)
                  </td>
                </tr>
                <tr>
                  <td className="p-4 text-lg font-medium">Body Cameras</td>
                  <td className="p-4 text-lg">
                    $12k/unit + $200/mo storage costs, privacy concerns
                  </td>
                </tr>
              </tbody>
            </table>
      ...
      content: (
        <div className="flex flex-col h-full">
          ...
          <div className="grid grid-cols-1 gap-4 mb-8">
            <div className="bg-skribh-deepnavy/80 p-6 border-l-4 border-skribh-navy">
          ...
          <div className="border-skribh-navy border-4 p-4 inline-block">
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col h-full">
          <h2 className="text-4xl font-bold mb-8 text-skribh-navy">Why Now?</h2>
          <h3 className="text-2xl font-bold mb-6">
            Perfect Storm for Adoption
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <h4 className="text-xl font-bold border-b border-skribh-navy pb-2">
                Technical
              </h4>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 bg-skribh-navy rounded-none mr-3 mt-2"></span>
                  AI transcription in doctor offices and AI translation in EMS
                  dispatch signals newfound readiness
                </li>
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 bg-skribh-navy rounded-none mr-3 mt-2"></span>
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col h-full">
          ...
          <div className="bg-skribh-deepnavy/80 border-l-4 border-skribh-navy p-8 mb-8">
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col h-full">
          ...
          <div className="overflow-hidden bg-skribh-deepnavy/80 border-l-4 border-skribh-navy mb-8">
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-skribh-navy/20">
                  <th className="p-4 text-left text-xl border-b border-white/10">
              ...
              <tbody>
                <tr className="border-b border-white/10">
                  ...
                  <td className="p-4 text-lg">
                    Manual entry workflows, focused on capturing market share
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col h-full">
          <h2 className="text-4xl font-bold mb-8 text-skribh-navy">Product</h2>
          <h3 className="text-2xl font-bold mb-6">Technical Differentiators</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="bg-skribh-deepnavy/80 border-l-4 border-skribh-navy rounded-none">
              <div className="p-6">
                <h4 className="text-xl font-bold mb-3">
                  Heavy-Tailed Self-Regularization
                </h4>
                <p className="text-lg opacity-80">
                  Advanced diagnostics ensure consistent performance even with
            ...
            <Card className="bg-skribh-deepnavy/80 border-l-4 border-skribh-navy rounded-none">
              <div className="p-6">
                <h4 className="text-xl font-bold mb-3">
                  HIPAA-certified Architecture
                </h4>
                <p className="text-lg opacity-80">
                  AES-256 encryption with secure mobile architecture
                </p>
              </div>
            </Card>
            <Card className="bg-skribh-deepnavy/80 border-l-4 border-skribh-navy rounded-none">
              <div className="p-6">
                ...
                <p className="text-lg opacity-80">
                  Continuous improvement from medic feedback loops
                </p>
              </div>
            </Card>
          </div>
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col items-center justify-center h-full">
          <h2 className="text-4xl font-bold mb-8 text-skribh-navy">Our Team</h2>
          <div className="bg-skribh-deepnavy/80 border-l-4 border-skribh-navy p-8 w-full max-w-3xl">
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col h-full">
          ...
          <div className="space-y-6">
            <div className="flex">
              <div className="w-20 h-20 bg-skribh-navy flex items-center justify-center text-2xl font-bold mr-6">
                I
              </div>
              <div className="flex-1 bg-skribh-deepnavy/80 border-l-4 border-skribh-navy p-6">
                <h4 className="text-xl font-bold mb-2">Phase I</h4>
                <p className="text-lg">
                  East Jefferson Ambulance (500 hrs audio validation)
                </p>
              </div>
            </div>
            <div className="flex">
      ...
      content: (
        <div className="flex flex-col h-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-center">
            <div className="bg-skribh-deepnavy/80 border-l-4 border-skribh-navy p-8">
            ...
            <div className="bg-skribh-deepnavy/80 border-l-4 border-skribh-navy p-8">
              ...
              <p className="text-xl">
                Year 3 ARR (330 agencies + hospital ERs)
              </p>
            </div>
          </div>
        </div>
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col items-center justify-center h-full text-center">
          <h2 className="text-4xl font-bold mb-8 text-skribh-navy">Vision</h2>
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-skribh-deepnavy/80 border-l-4 border-skribh-navy p-8">
              ...
              <p className="text-xl">
                Voice biomarker integration (stroke detection)
              </p>
            </div>
            <div className="bg-skribh-deepnavy/80 border-l-4 border-skribh-navy p-8">
              <div className="text-3xl font-bold mb-4">2026</div>
              <p className="text-xl">
                Multilingual support (Spanish/ALS-compatible)
              </p>
            </div>
          </div>
        </div>
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col h-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-skribh-deepnavy/80 p-8 border-l-4 border-skribh-navy">
      ...
      content: (
        <div className="flex flex-col items-center justify-center h-full text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl">
            For detailed financial information, pitch deck, and to schedule a
            meeting with our founders, please contact our investment relations
            team.
          </p>
          <Link to="/#contact">
  ...
  slides.forEach((slide, index) => {
    ...
    if (index === 0) {
      ...
      slide.content = (
        <div className="flex flex-col items-center justify-center h-full">
          <div className="flex w-full md:justify-end justify-center mb-8">
            <Link to="/#contact">
              <Button type="button" className="skribh-button">
      ...
      if (
        !originalContent.props.children.some((child) =>
  ...
  const investorResources = [
    {
      ...
      icon: <Presentation className="h-8 w-8 text-skribh-navy" />,
    ...
    },
    {
      ...
      icon: <FileText className="h-8 w-8 text-skribh-navy" />,
    ...
    },
    {
      ...
      icon: <BarChart className="h-8 w-8 text-skribh-navy" />,
    ...
    },
    {
      ...
      icon: <TrendingUp className="h-8 w-8 text-skribh-navy" />,
      action: () => handleContactClick(),
      comingSoon: true,
    },
    {
      ...
      icon: <Clock className="h-8 w-8 text-skribh-navy" />,
      action: () => handleContactClick(),
      comingSoon: true,
    },
  ];
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-center mb-8">
          <Link to="/#contact">
            <Button type="button" className="skribh-button text-xl" size="lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
          {investorResources.map((resource) => (
            <button
              ...
              className="text-left bg-skribh-deepnavy/80 border-l-4 border-skribh-navy rounded-none p-4 hover:bg-skribh-deepnavy/90 transition-colors h-full relative"
            >
              <div className="flex flex-col items-center text-center h-full">
                <div className="mb-3">{resource.icon}</div>
                <h3 className="text-lg font-bold mb-2">{resource.title}</h3>
                <p className="text-sm text-navy">{resource.description}</p>

                {resource.comingSoon && (
                  <div className="absolute top-0 right-0 bg-skribh-navy text-white text-xs font-bold py-1 px-2 transform rotate-0">
                    COMING SOON
                  </div>
                )}
              </div>
  ...
  return (
    <div className="min-h-screen bg-skribh-deepnavy text-white font-helvetica">
      {/* Header */}
      <header className="bg-skribh-deepnavy border-b border-zinc-800 py-6">
          ...
          <div className="flex items-center">
            {viewMode === "landing" ? (
              <Link to="/" className="mr-6">
                <Button
                  variant="ghost"
                  className="text-white hover:bg-skribh-navy/20"
                >
              ...
              <Button
                variant="ghost"
                className="mr-6 text-white hover:bg-skribh-navy/20"
                onClick={() => setViewMode("landing")}
              >
                <ArrowLeft className="mr-2 h-5 w-5" /> Back to Resources
              </Button>
            )}
            <h1 className="text-3xl font-bold text-skribh-navy">
              {viewMode === "landing"
        ...
        <main className="container mx-auto px-4 py-12 min-h-[calc(100vh-160px)] relative">
          ...
          <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 flex justify-between px-4 pointer-events-none">
            <Button
              ...
              className="bg-skribh-deepnavy/50 text-white hover:bg-skribh-deepnavy/70 pointer-events-auto"
            >
          ...
          {/* Slide Counter */}
          <div className="absolute bottom-4 right-4 bg-skribh-deepnavy/50 px-3 py-1 rounded-md text-sm">
