    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="max-w-7xl mx-auto mb-8">
        <div className="bg-white rounded-lg shadow-sm p-6">
          <h1 className="text-4xl font-bold text-gray-900 mb-2 flex items-center">
            <PieChart className="h-10 w-10 mr-3 text-blue-500" />
            🥧 Dynamic Slicing Pie Calculator
          </h1>
          <p className="text-lg text-gray-600 mb-4">
            Interactive equity allocation calculator using the Slicing Pie model
          </p>
          <div className="text-sm text-gray-500">
            ...
            <a href="/working-canvas" className="text-blue-600 hover:underline ml-2">Working Canvas</a>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-lg shadow-sm p-8">
          {/* What is Slicing Pie */}
          <div className="mb-8 p-6 rounded-lg bg-blue-50">
            <h3 className="text-xl font-bold mb-4 text-gray-800">What is Slicing Pie?</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="p-4 rounded-lg bg-white">
                ...
                <p className="text-sm text-gray-600">Equity adjusts based on actual contributions, not promises</p>
              </div>
              <div className="p-4 rounded-lg bg-white">
                <h4 className="font-bold text-green-500 mb-2">Transparent</h4>
                <p className="text-sm text-gray-600">Everyone can see exactly how equity is calculated</p>
              </div>
              <div className="p-4 rounded-lg bg-white">
                <h4 className="font-bold text-purple-500 mb-2">Motivating</h4>
                <p className="text-sm text-gray-600">More contribution = more equity, encouraging active participation</p>
              </div>
            </div>
          </div>

          {/* Controls */}
          <div className="p-6 rounded-lg mb-8 bg-gray-100">
            <h3 className="text-xl font-bold mb-4 text-gray-800">Investment Scenario Controls</h3>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div>
                <label className="block font-medium text-gray-800 mb-2">Weeks Until Freeze</label>
                <input
                  type="number"
                  value={weeksToFreeze}
              ...
              <div>
                <label className="block font-medium text-gray-800 mb-2">Your Investment</label>
                <input
                  type="number"
              ...
              <div>
                <label className="block font-medium text-gray-800 mb-2">Exit Sale Price</label>
                <select
                  value={salePrice}
            ...
            <div className="p-6 rounded-lg bg-white border border-gray-200">
              ...
              <div className="grid grid-cols-3 gap-2 mb-4">
                <input
                  ...
                  className="p-2 rounded border text-sm bg-white border-gray-300"
                />
                <input
                  type="number"
                  placeholder="$/hr"
              ...
              <div className="space-y-3 max-h-64 overflow-y-auto">
                {Object.entries(participants).map(([name, data]) => {
                  ...
                  return (
                    <div key={name} className="p-3 rounded-lg border bg-gray-50 border-gray-200">
                      ...
                      <div className="grid grid-cols-3 gap-2 text-sm">
                        <div>
                          <span className="text-gray-600">Slices:</span>
                        ...
                        <div>
                          <span className="text-gray-600">Hrs/week:</span>
                          <input
                            type="number"
                            value={data.weeklyHours}
                            onChange={(e) => updateWeeklyHours(name, parseInt(e.target.value))}
                            className="w-full mt-1 p-1 rounded border text-sm bg-white border-gray-300"
                          />
                        </div>
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Slicing Pie Option */}
            <div className="p-6 rounded-lg border-2 border-green-500 bg-white">
              ...
              <div className="space-y-2 text-sm">
                <h4 className="font-bold text-gray-800 mb-2">Breakdown:</h4>
                ...
                <div className="flex justify-between font-bold border-t pt-2">
                  <span className="text-gray-800">Your Investment:</span>
            ...
            {/* SAFE Option */}
            <div className="p-6 rounded-lg border-2 border-red-500 bg-white">
              ...
              <div className="p-4 rounded-lg bg-gray-100 mb-4">
                <h4 className="font-bold text-gray-800 mb-2">SAFE Terms:</h4>
                <div className="text-sm space-y-1">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Valuation Cap:</span>
                    <span className="text-gray-800">{formatCurrency(SAFE_VAL_CAP)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Investment:</span>
                    <span className="text-gray-800">{formatCurrency(andyInvestment)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Ownership:</span>
                    <span className="text-gray-800">{(results.safePercent * 100).toFixed(2)}%</span>
                  </div>
                </div>
              </div>
          ...
          {/* Key Insights */}
          <div className="mt-8 p-6 rounded-lg bg-yellow-50 border-l-4 border-yellow-500">
            <h3 className="text-xl font-bold mb-4 text-gray-800 flex items-center">
